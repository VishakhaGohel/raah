            ...
            <section className="funfacts-section">
                <div className="auto-container">
                    <div className="sec-title text-center">
                        ...
                        <div className="text">We're dedicated to making a difference in people's lives.Here's a glimpse of our impact</div>
                    </div>
                        ...
                        <div className="funfact-wrapper row">
                            {
                                counterBlocksData.map(
                                    (a,i) => (
                                        <CounterBlocksData key={i} delay={a.delay} img={a.iconSrc} title={a.title} end={a.endValue} decimals={a.decimals} duration={a.duration} separator={a.separator} affix={a.affix} text={a.text} />
                                    )
                                )
                            }
                        </div>
